...
public class JwtService {
    ...
    public String generateToken(Map<String, Object> extraClaims, UserDetails userDetails, Long tenantId) {
    ...
    private Key getSignInKey() {
        return Keys.hmacShaKeyFor(SECRET_KEY.getBytes());  // Encodage sécurisé
    }
}
