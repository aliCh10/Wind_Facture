package com.example.services_ser.config;
...
import com.example.services_ser.security.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(authorize -> authorize
                .requestMatchers("/services/**").authenticated() // L'utilisateur doit être authentifié
                .requestMatchers("/services/**").hasAuthority("ROLE_PARTNER") // L'utilisateur doit avoir l'autorité ROLE_PARTNER
